...
public class FileAlterationObserver implements Serializable {
     ...
     */
    public FileAlterationObserver(String directoryName, FileFilter fileFilter, long timeout) {
        this(new File(directoryName), fileFilter, timeout);
    }
     ...
     */
    public FileAlterationObserver(String directoryName, FileFilter fileFilter, long timeout, IOCase caseSensitivity) {
        this(new File(directoryName), fileFilter, timeout, caseSensitivity);
    }
    ...
    public FileAlterationObserver(File directory){
    	this(directory, (FileFilter) null, 1);
    }
     ...
     */
    public FileAlterationObserver(File directory, long timeout) {
        this(directory, (FileFilter)null, timeout);
    }
     ...
     * @param fileFilter The file filter or null if none
     */
    public FileAlterationObserver(File directory, FileFilter fileFilter, long timeout) {
        this(directory, fileFilter, timeout, (IOCase)null);
    }
     ...
     * @param caseSensitivity  what case sensitivity to use comparing file names, null means system sensitive
     */
    public FileAlterationObserver(File directory, FileFilter fileFilter, long timeout, IOCase caseSensitivity) {
        this(new FileEntry(directory), fileFilter, timeout, caseSensitivity);
    }
     ...
     * @param caseSensitivity  what case sensitivity to use comparing file names, null means system sensitive
     */
    protected FileAlterationObserver(FileEntry rootEntry, FileFilter fileFilter, long timeout, IOCase caseSensitivity) {
        if (rootEntry == null) {
